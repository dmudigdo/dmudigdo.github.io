---
layout: post
title: "My First Spin on NotebookLM"
categories: ai
comments: true
---
...
## Conclusion
What I just did would more appropriately be classed as 'party trick'. However, it does illustrate the capabilities of NotebookLM. The non-learning possible uses are endless, just have a look on YouTube to see what people are doing with it. Some are even using it to [generate monetisable content](https://www.youtube.com/results?search_query=monetise+notebooklm){:target="_blank"}, e.g. finding book summaries that are in demand, getting NotebookLM to summarise it (text, audio or video), and then sell it. I hope this has got you interested in trying it out, if you already have a Google account, just go to [notebooklm.google.com](https://notebooklm.google.com){:target="_blank"}.
